...
function CopySvg () {
    return `<span class="copy-wrapper">
        <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" class="copy-svg">
...
function SuccessSvg () {
    return `<span class="success-wraper">
        <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" class="success-svg">
